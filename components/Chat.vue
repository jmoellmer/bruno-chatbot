<template>
    <section class="flex flex-col min-w-[520px] w-full">
        ...
        <!-- Messages -->
        <div class="flex flex-col gap-3.5 py-5 px-3 overflow-y-scroll max-h-[400px]">
            <!-- To flip message use "flex-row-reverse" -->
            <div class="flex items-end gap-3">
                <!-- Profile Image -->
                <img class="block w-12 h-12 overflow-hidden rounded-full border-2 border-slate-200/70"
                    src="/bruno.svg" />
                <!-- Text Image -->
                <!-- <div
            ...
            <div class="flex flex-row-reverse items-end gap-3">
                <!-- Profile Image -->
                <div class="flex uppercase items-center justify-center text-xl text-center text-white font-bold bg-gradient-to-t from-sky-500 to-emerald-500 w-12 h-12 overflow-hidden rounded-full border-2 border-slate-200/70"
                    src="/bruno.svg">
                    js
                </div>
                <!-- Main Content -->
